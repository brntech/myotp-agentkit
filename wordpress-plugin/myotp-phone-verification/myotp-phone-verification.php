...
/**
 * Boot the plugin. Translations load on demand from WordPress.org
 * language packs (WordPress 4.6+), so the text domain is not loaded here.
 */
